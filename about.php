   ...
   <div class="service padding-top--big">
        ...
        <div class="team_mate_flexbox padding-top--medium padding-bottom--medium">
          <div class="mate_picture">
            <img class="mate_img" src="<?php bloginfo('template_url'); ?>/assets/images/evrard.png" alt="evrard_picture">
          </div>
          ...
          <div class="mate_description">
            ...
            A la sortie de cette école, Evrard s’engage chez Atos en tant que développeur front-end et consultant UX.
        ...
        <div class="team_mate_flexbox padding-top--medium padding-bottom--medium">
          <div class="mate_description">
            <p class="paragraphe">Audrey est une créative dans l’âme. Après avoir travaillé 2 années en tant que business analyste dans une société de conseil à Bruxelles, elle décide de tout lacher pour suivre sa passion pour le design et la creation.

            Elle entame alors une formation de développement Front-End, à la Wild Code School, où elle apprend à coder et pofinne, par la suite, ses bases lors d’un stage chez World of Digits.
          ...
          <div class="mate_picture">
            <img class="mate_img" src="<?php bloginfo('template_url'); ?>/assets/images/audrey.jpg" alt="audrey_picture">
          </div>
        </div>
   </div>
</section>
